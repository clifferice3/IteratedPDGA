  ...
  // -1 = Start of game, 0 = CC, 1 = CD, DC = 2, DD = 3 in decision array indexing
   ...
   public int nextMove(){
		if(start)
		{
			...
			else if (lastMoves[3] == -1){
				return startMoves[9 + lastMoves[0] + lastMoves[1] + lastMoves[2]);
			)
		}
		else
		{
			return decisions[lastMoves[0]][lastMoves[1]][lastMoves[2]][lastMoves[3]];
		}
    }  /* nextMove */
